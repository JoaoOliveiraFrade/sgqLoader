...
namespace sgq
{
    public static class Gerais
    {
        ...
        public static void Download_from_BD(HttpResponse oResponse, String Id)
        {
            ...
            DataTable oDataTable = SGQConn.Get_DataTable(String.Format("select Nome, Tipo, Dados from SGQ_Arquivos where id={0}", Id));
        ...
        public static string LerCampsql(string StringsConexao, string Sql)
        {
            BD oBD = new BD(StringsConexao);
