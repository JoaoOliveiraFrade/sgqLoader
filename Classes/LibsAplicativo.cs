...
public static class Lib
{
    public static string SGQ()
    {
        if (Convert.ToBoolean(WebConfigurationManager.AppSettings["Producao"]))
            return WebConfigurationManager.ConnectionStrings["SGQ"].ToString();
        else
            return WebConfigurationManager.ConnectionStrings["SGQDev"].ToString();
    }

    public static string BITI()
    {
        return @"Data Source=10.32.204.66\dbinst1,1440;Initial Catalog=BDGestaoTestes;Persist Security Info=True; Timeout=1000; User ID=SGTBD0;Password=bsh81Kzr";
    }

    public static string QC11()
    {
        return "Data Source=btdf5377.brasiltelecom.com.br:1530/QC11PRD1;Persist Security Info=True;User ID=QC11PRD1;Password=jfrade#171;Unicode=True";
    }
    ...
    public static string QC11SP()
    {
        ...
        //return "Data Source=btdf5377.brasiltelecom.com.br:1530/QC11PRD1;Persist Security Info=True;User ID=SDGM6001;Password=1#alm110$d2;Unicode=True";
        return "Data Source=btdf5377.brasiltelecom.com.br:1530/QC11PRD1;Persist Security Info=True;User ID=SDGM6001;Password=jfrade#171;Unicode=True";
